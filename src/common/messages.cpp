...
bilingual_str TransactionErrorString(const TransactionError err)
{
    switch (err) {
        ...
        case TransactionError::MAX_TOTAL_BURN_EXCEEDED:
            return Untranslated("Total value of unspendable outputs exceeds maximum configured by user (maxtotalburnamount)");
